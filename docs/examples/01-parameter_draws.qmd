...
::::: {.callout-tip}
## Toggle between plotting backends

Each plot above has **lets-plot** and **plotnine** tabs. The plot code differs only by import — the `Geom` layer specification is identical. This demonstrates that `tidydraws` is backend-agnostic.
:::::
