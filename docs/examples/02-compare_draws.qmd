...
(
    ...
    + geom_pointrange(aes(ymin="lower", ymax="upper"), position=position_dodge(0.5), size=0.8)
    + geom_pointrange(
        data=truth.to_pandas(),
    ...
    + labs(x="group", y="beta (89% CrI)", color="source", title="Prior vs posterior credible intervals")
    + theme_minimal()
)
```
